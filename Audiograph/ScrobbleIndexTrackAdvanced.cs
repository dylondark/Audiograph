...
namespace Audiograph
{
                        ...
                        Invoke(new Action(() =>
   {
        ...
        private void OK(object sender, EventArgs e)
        {
            ...
            {
                My.MyProject.Forms.frmScrobbleIndexAddRow.txtTitle.Text = txtTrack.Text.Trim();
                My.MyProject.Forms.frmScrobbleIndexAddRow.txtArtist.Text = txtArtist.Text.Trim();
                if (txtAlbum.Text != "N/A" && txtAlbum.Text.Contains("ERROR: ") == false)
                {
                    My.MyProject.Forms.frmScrobbleIndexAddRow.txtAlbum.Text = txtAlbum.Text.Trim();
                }
                Close();                                      // close window
            }
