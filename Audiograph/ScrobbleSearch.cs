...
namespace Audiograph
{
                        ...
                        Invoke(new Action(() =>
   {
                        ...
                        // parse data
                        string[] tracknodes = new[] { "name", "artist/name", "album/title", "userplaycount" };
                            ...
                            Invoke(new Action(() =>
       {
        ...
        private void MBID(object sender, EventArgs e)
        {
            ...
            // get info or error
            string[] infonodes = new string[] { "name", "artist/name", "album/title", "userplaycount" };
        ...
        {
            if (!string.IsNullOrEmpty(txtTrack.Text) && !string.IsNullOrEmpty(txtArtist.Text))    // if there is data in both boxes
            {
                if (txtTrack.Text != "N/A" && txtTrack.Text.Contains("ERROR: ") == false)
                {
                    My.MyProject.Forms.frmMain.txtMediaTitle.Text = txtTrack.Text.Trim();
                }
                else
                {
                    My.MyProject.Forms.frmMain.txtMediaTitle.Text = string.Empty;
                }
                if (txtArtist.Text != "N/A" && txtArtist.Text.Contains("ERROR: ") == false)
                {
                    My.MyProject.Forms.frmMain.txtMediaArtist.Text = txtArtist.Text.Trim();
                }
                else
                {
                    My.MyProject.Forms.frmMain.txtMediaArtist.Text = string.Empty;
                }
                if (txtAlbum.Text != "N/A" && txtAlbum.Text.Contains("ERROR: ") == false && txtAlbum.Text.Contains("Loading") == false)
                {
                    My.MyProject.Forms.frmMain.txtMediaAlbum.Text = txtAlbum.Text.Trim();
                }
                else
                {
                    My.MyProject.Forms.frmMain.txtMediaAlbum.Text = string.Empty;
                }
                Close();                                      // close window
            }
