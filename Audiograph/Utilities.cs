...
namespace Audiograph
{
    static class Utilities
    {
        ...
        #region Vars
        public static List<string[]> apihistory = new List<string[]>();  // used for api call history
        public static List<string[]> scrobblehistory = new List<string[]>(); // used for scrobble history
        ...
        public static List<string[]> originalqueue = new List<string[]>();   // original queue for media
        public static bool addingqueue;      // true when something is currently being added to the queue
        public static List<string[]> queueremoved = new List<string[]>();    // list of removed queue items when shuffle is activated
        public static int timezoneoffset;   // unix time offset for time zone
        public static List<string[]> scrobbleindexdata = new List<string[]>();   // 0 = filename, 1 = title, 2 = artist, 3 = album
        public static bool newsong = true;    // true when mediaplayer is playing a new song, false when the song has already been scrobbled
        #endregion

        #region Methods
        // callapi get request
        public static string CallAPI(string method, string user = "", string param1 = "", string param2 = "", string param3 = "", string param4 = "")
        {
            // url formatting
            ...
            DateTime starttime = new DateTime(), endtime = new DateTime();  // timekeeping
        ...
        public static string CallAPIAuth(string method, string param1 = "", string param2 = "", string param3 = "", string param4 = "")
        {
            // data formatting
            ...
            postdata.Append("sk=" + My.MySettingsProperty.Settings.SessionKey + "&");       // session key
        ...
        {
            if (xml.Contains(metadata) == true)                                                               // proceed if xml input contains specified metadata
            {
                ...
                try
                {
                    while (instances.Count != count)
                    {
                        ...
                        {
                            firstquotpos = (uint)Strings.InStr(metadatapos, xml, Conversions.ToString('"'));                                 // get the pos of the first quotation mark
                            secondquotpos = (uint)Strings.InStr((int)(firstquotpos + 1L), xml, Conversions.ToString('"'));                           // get the pos of the second quotation mark
                            instances.Add(xml.Substring((int)firstquotpos, (int)(secondquotpos - firstquotpos - 1L)));    // add metadata to list
        ...
        // create api_sig
        public static string CreateSignature(string method, string param1 = "", string param2 = "", string param3 = "", string param4 = "", bool sk = true)
        {
            // formatting
            ...
            if (sk == true)
            {
                @params.Add("sk" + My.MySettingsProperty.Settings.SessionKey);
            }
            // param1
            if (!string.IsNullOrEmpty(param1))
            {
        ...
        {
            // check for errors
            if (track.Contains("ERROR: ") == true || artist.Contains("ERROR: ") == true)
            {
                return;
            }

            My.MyProject.Forms.frmMain.Invoke(new Action(() => My.MyProject.Forms.frmMain.txtTrackTitle.Text = track));
            My.MyProject.Forms.frmMain.Invoke(new Action(() => My.MyProject.Forms.frmMain.txtTrackArtist.Text = artist));
            My.MyProject.Forms.frmMain.Invoke(new Action(() => My.MyProject.Forms.frmMain.tabControl.SelectTab(2)));
            My.MyProject.Forms.frmMain.Invoke(new Action(() => My.MyProject.Forms.frmMain.btnTrackGo.Select()));
            My.MyProject.Forms.frmMain.btnTrackGo.PerformClick();
        }

        public static void GoToArtist(string artist)
        {
            // check for errors
            if (artist.Contains("ERROR: ") == true)
            {
                return;
            }

            My.MyProject.Forms.frmMain.Invoke(new Action(() => My.MyProject.Forms.frmMain.txtArtistName.Text = artist));
            My.MyProject.Forms.frmMain.Invoke(new Action(() => My.MyProject.Forms.frmMain.tabControl.SelectTab(3)));
            My.MyProject.Forms.frmMain.Invoke(new Action(() => My.MyProject.Forms.frmMain.btnArtistGo.Select()));
            My.MyProject.Forms.frmMain.btnArtistGo.PerformClick();
        }

        public static void GoToAlbum(string album, string artist)
        {
            // check for errors
            if (album.Contains("ERROR: ") == true || artist.Contains("ERROR: ") == true)
            {
                return;
            }

            My.MyProject.Forms.frmMain.Invoke(new Action(() => My.MyProject.Forms.frmMain.txtAlbumTitle.Text = album));
            My.MyProject.Forms.frmMain.Invoke(new Action(() => My.MyProject.Forms.frmMain.txtAlbumArtist.Text = artist));
            My.MyProject.Forms.frmMain.Invoke(new Action(() => My.MyProject.Forms.frmMain.tabControl.SelectTab(4)));
            My.MyProject.Forms.frmMain.Invoke(new Action(() => My.MyProject.Forms.frmMain.btnAlbumGo.Select()));
            My.MyProject.Forms.frmMain.btnAlbumGo.PerformClick();
        }

        public static void BackupTag(string tag)
        {
            // check for errors
            if (tag.Contains("ERROR: ") == true)
            {
                return;
            }
            ...
            My.MyProject.Forms.frmBackupTool.cmbContents.SelectedIndex = 1;
            My.MyProject.Forms.frmBackupTool.txtTagTag.Text = tag;
        }
        ...
        public static void BackupTrack(string track, string artist)
        {
            ...
            My.MyProject.Forms.frmBackupTool.Show();
            My.MyProject.Forms.frmBackupTool.Activate();
            My.MyProject.Forms.frmBackupTool.cmbContents.SelectedIndex = 2;
            My.MyProject.Forms.frmBackupTool.txtTrackTitle.Text = track;
            My.MyProject.Forms.frmBackupTool.txtTrackArtist.Text = artist;
        }
        ...
        public static void BackupArtist(string artist)
        {
            ...
            My.MyProject.Forms.frmBackupTool.Show();
            My.MyProject.Forms.frmBackupTool.Activate();
            My.MyProject.Forms.frmBackupTool.cmbContents.SelectedIndex = 3;
            My.MyProject.Forms.frmBackupTool.txtArtistArtist.Text = artist;
        }
        ...
        public static void BackupAlbum(string album, string artist)
        {
            ...
            My.MyProject.Forms.frmBackupTool.Show();
            My.MyProject.Forms.frmBackupTool.Activate();
            My.MyProject.Forms.frmBackupTool.cmbContents.SelectedIndex = 4;
            My.MyProject.Forms.frmBackupTool.txtAlbumAlbum.Text = album;
            My.MyProject.Forms.frmBackupTool.txtAlbumArtist.Text = artist;
        }

        public static void BackupUser(string user)
        {
            // check for errors
            if (user.Contains("ERROR: ") == true)
            {
                return;
            }
            ...
            My.MyProject.Forms.frmBackupTool.Show();
            My.MyProject.Forms.frmBackupTool.Activate();
            My.MyProject.Forms.frmBackupTool.cmbContents.SelectedIndex = 5;
            My.MyProject.Forms.frmBackupTool.txtUserUser.Text = user;
        }
        ...
        public static void AddAPIHistory(bool post, string method, string status, int latency, DateTime time, string thread)
        {
            ...
            string[] listarray = new string[] { poststring, method, status, latency.ToString("N0") + "ms", time.ToString("G"), thread };
        ...
        public static string VerifyTag(string tag)
        {
            ...
            string[] tagnodes = new[] { "name", "total" };
        ...
        public static string[] VerifyTrack(string track, string artist)
        {
            ...
            string[] tracknodes = new[] { "name", "artist/name", "album/title" };
        ...
        public static string[] VerifyAlbum(string album, string artist)
        {
            ...
            string[] albumnodes = new[] { "name", "artist" };
        ...
        public static string[] Scrobble(string track, string artist, uint timestamp, string source, string album = "")
        {
            ...
            // parse response
            string[] responsenodes = new[] { "track", "artist", "album", "timestamp", "ignoredMessage" };
            ParseXML(response, "/lfm/scrobbles/scrobble", 0U, ref responsenodes);

            // status
            // check for error
            if (track.Contains("ERROR: ") == true)
            {
            ...
            // add to listviews
            My.MyProject.Forms.frmMain.ltvMediaHistory.Items.Insert(0, responsenodes[0]).SubItems.AddRange(new[] { responsenodes[1], responsenodes[4] });
            scrobblehistory.Add(new[] { responsenodes[0], responsenodes[1], responsenodes[2], UnixToDate((uint)Math.Round(Conversions.ToDouble(responsenodes[3]) + timezoneoffset)).ToString("G"), UnixToDate((uint)(GetCurrentUTC() + timezoneoffset)).ToString("G"), source, responsenodes[4] });
