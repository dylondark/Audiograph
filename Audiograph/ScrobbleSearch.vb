...
Public Class frmScrobbleSearch
    ...
    Private Sub SelectSearchItem(sender As Object, e As ListViewItemSelectionChangedEventArgs) Handles ltvResults.ItemSelectionChanged
        If ltvResults.SelectedItems.Count > 0 Then
            ...
            Dim th As New Thread(Sub()
                                     ...
                                     ' parse data
                                     Dim tracknodes As String() = {"name", "artist/name", "album/title", "userplaycount"}
    ...
    Private Sub MBID(sender As Object, e As EventArgs) Handles btnMBID.Click
        ...
        ' get info or error
        Dim infonodes() As String = {"name", "artist/name", "album/title", "userplaycount"}
        ...
        If infonodes(0).Contains("ERROR: ") = False Then
            ...
            If infonodes(3).Contains("ERROR: ") = False Then
                Try
                    txtPlaycount.Text = CInt(infonodes(3)).ToString("N0")
                Catch ex As Exception
    ...
    Private Sub OK(sender As Object, e As EventArgs) Handles btnOK.Click
        If txtTrack.Text <> String.Empty AndAlso txtArtist.Text <> String.Empty Then    ' if there is data in both boxes
            If txtTrack.Text <> "N/A" AndAlso txtTrack.Text.Contains("ERROR: ") = False Then
                frmMain.txtMediaTitle.Text = txtTrack.Text.Trim
            Else
                frmMain.txtMediaTitle.Text = String.Empty
            End If
            If txtArtist.Text <> "N/A" AndAlso txtArtist.Text.Contains("ERROR: ") = False Then
                frmMain.txtMediaArtist.Text = txtArtist.Text.Trim
            Else
                frmMain.txtMediaArtist.Text = String.Empty
            End If
            If txtAlbum.Text <> "N/A" AndAlso txtAlbum.Text.Contains("ERROR: ") = False AndAlso txtAlbum.Text.Contains("Loading") = False Then
                frmMain.txtMediaAlbum.Text = txtAlbum.Text.Trim
            Else
                frmMain.txtMediaAlbum.Text = String.Empty
            End If
