...
namespace Audiograph
{
    public partial class frmArtistAdvanced
    {
        ...
        private void Search(object sender, EventArgs e)
        {
            ...
            // get search results
            string results = Utilities.CallAPI("artist.search", "", "artist=" + txtSearchArtist.Text.Trim().Replace(" ", "+"));
            ...
            if (status.Contains("ok") == true)
            {
                ...
                {
                    // parse for data
                    string[] searchnodes = new string[] { "name", "listeners" };
                    ...
                    if (searchnodes[0].Contains("ERROR: ") == false)
                    {
                        ...
                        ltvResults.Items[count].SubItems.Add(Conversions.ToUInteger(searchnodes[1]).ToString("N0"));  // listeners
                    }
                }
            }
            else    // if errors
        ...
        private void MBID(object sender, EventArgs e)
        {
            ...
            // get info or error
            string[] infonodes = new string[] { "name", "stats/listeners" };
